...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    "git.pullAvailableDesc": "El repositorio remoto tiene {count} commit(s) que no están en tu copia local. ¿Querés traerlos?",
    ...
    "git.pullDenied": "Los cambios locales pueden divergir del remoto. Usá 'Traer cambios' para sincronizar cuando quieras.",
    "git.pullUncommitted": "Hay cambios locales sin guardar. Guardá o descartá los cambios antes de sincronizar.",
